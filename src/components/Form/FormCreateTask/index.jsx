...
import { SET_SUBMIT_CREATE_TASK } from "../../../redux/constants/Drawer/DrawerConstant";
import { GET_ALL_PRIORITY_SAGA } from "../../../redux/constants/Priority/PriorityConstant";
import {GET_ALL_PROJECT_SAGA} from "../../../redux/constants/Project/ProjectConstant"
import { GET_ALL_STATUS_SAGA } from "../../../redux/constants/Status/StatusConstant";
import { CREATE_TASK_SAGA } from "../../../redux/constants/Task/TaskConstant";
import { GET_ALL_TASK_TYPE_SAGA } from "../../../redux/constants/Task/TaskTypeConstant"
import { GET_USER_API_SAGA, GET_USER_BY_PROJECT_ID_SAGA } from "../../../redux/constants/User/UserCyberBugsConstant";
...
function FormCreateTask(props) {
  ...
  // Hàm beiens đổi option cho thẻ select
  ...
  useEffect(() => {
    ...
    dispatch({ type: GET_ALL_STATUS_SAGA, keyword: "" });
    
    //Đưa hàm handle submit lên drawer reducer để cập nhậy lại sử kieneh cho nút submit
